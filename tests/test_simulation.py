...
from backtest_lab.simulation import simulate_buy_and_hold, simulate_relative_strength_top1


def price_frame(open_price: float, close_start: float, daily_step: float, rows: int = 90) -> pd.DataFrame:
    dates = pd.bdate_range("2023-09-01", periods=rows)
