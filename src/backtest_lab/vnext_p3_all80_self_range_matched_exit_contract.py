...
def run() -> None:
    ...
    pd.DataFrame([{"source_package":"Radar all80 KRangeGT30 matched-exit official OHLC fill","accepted_legs":11,"affected_event_platform_rows":62,"blocked_legs":0,"absorbed":True,"future_data_violation_count":0}]).to_csv(OUT / "p3_all80_KrangeGT30_execution_patch_absorption_audit.csv",index=False,encoding="utf-8-sig")
