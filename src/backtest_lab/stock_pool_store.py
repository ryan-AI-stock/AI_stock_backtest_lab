    ...
    return {
        ...
        "pools": [
            ...
            },
            {
                ...
                "operational_observation": True,
                "vote_group": "three_perspective_v1",
                "role_name": "核心防守與機會成本專家",
                "role_description": "檢查資金是否從主線攻擊轉向其他穩健風格；每個風格只取一檔當期代表，避免金融或傳產因成員較多而取得不公平票數。",
                "candidate_review_frequency": "monthly",
                "candidate_review_config": {
                ...
                "candidate_update_policy": "月頻檢查跨產業核心代理池；每個風格 bucket 只保留一檔當期代表，依產業代表性、防守韌性、機會成本、基本面品質與月頻審核分數更新，不追逐每日短線漲跌。",
                "description": "核心風格代表池：跨市場曝險、半導體、金融、電信、消費、傳產與景氣循環等風格，每個風格先選一檔代表，再與其他風格代表競爭；台積電在此視為市場核心股，不是純 AI 題材股。",
