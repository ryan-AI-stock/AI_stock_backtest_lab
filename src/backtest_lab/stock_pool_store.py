...
KNOWN_SYMBOLS: dict[str, dict[str, str]] = {
    ...
    "2059.TW": {"symbol": "2059", "name": "川湖", "asset_type": "stock"},
    "2207.TW": {"symbol": "2207", "name": "和泰車", "asset_type": "stock"},
    "2301.TW": {"symbol": "2301", "name": "光寶科", "asset_type": "stock"},
    ...
    "2615.TW": {"symbol": "2615", "name": "萬海", "asset_type": "stock"},
    "2880.TW": {"symbol": "2880", "name": "華南金", "asset_type": "stock"},
    "2881.TW": {"symbol": "2881", "name": "富邦金", "asset_type": "stock"},
    "2882.TW": {"symbol": "2882", "name": "國泰金", "asset_type": "stock"},
    "2883.TW": {"symbol": "2883", "name": "凱基金", "asset_type": "stock"},
    "2884.TW": {"symbol": "2884", "name": "玉山金", "asset_type": "stock"},
    "2885.TW": {"symbol": "2885", "name": "元大金", "asset_type": "stock"},
    "2886.TW": {"symbol": "2886", "name": "兆豐金", "asset_type": "stock"},
    "2887.TW": {"symbol": "2887", "name": "台新金", "asset_type": "stock"},
    "2890.TW": {"symbol": "2890", "name": "永豐金", "asset_type": "stock"},
    ...
    "2345.TW": {"symbol": "2345", "name": "智邦", "asset_type": "stock"},
    "2327.TW": {"symbol": "2327", "name": "國巨", "asset_type": "stock"},
    "2357.TW": {"symbol": "2357", "name": "華碩", "asset_type": "stock"},
    "2379.TW": {"symbol": "2379", "name": "瑞昱", "asset_type": "stock"},
    ...
    "2383.TW": {"symbol": "2383", "name": "台光電", "asset_type": "stock"},
    "2395.TW": {"symbol": "2395", "name": "研華", "asset_type": "stock"},
    "3008.TW": {"symbol": "3008", "name": "大立光", "asset_type": "stock"},
    "3017.TW": {"symbol": "3017", "name": "奇鋐", "asset_type": "stock"},
    "3034.TW": {"symbol": "3034", "name": "聯詠", "asset_type": "stock"},
    "3231.TW": {"symbol": "3231", "name": "緯創", "asset_type": "stock"},
    "3661.TW": {"symbol": "3661", "name": "世芯-KY", "asset_type": "stock"},
    "3711.TW": {"symbol": "3711", "name": "日月光投控", "asset_type": "stock"},
    "4904.TW": {"symbol": "4904", "name": "遠傳", "asset_type": "stock"},
    "4938.TW": {"symbol": "4938", "name": "和碩", "asset_type": "stock"},
    "5871.TW": {"symbol": "5871", "name": "中租-KY", "asset_type": "stock"},
    "5876.TW": {"symbol": "5876", "name": "上海商銀", "asset_type": "stock"},
    "5880.TW": {"symbol": "5880", "name": "合庫金", "asset_type": "stock"},
    "6505.TW": {"symbol": "6505", "name": "台塑化", "asset_type": "stock"},
    "6669.TW": {"symbol": "6669", "name": "緯穎", "asset_type": "stock"},
    "6919.TW": {"symbol": "6919", "name": "康霈*", "asset_type": "stock"},
}
        ...
        "pools": [
            {
                ...
                "candidate_update_policy": "月頻檢查候選名單；v1 先固定候選，未來用 AI 主線受惠程度、市值流動性、基本面品質與題材強度維護，不能用每日短線漲幅自動亂換成員。",
            ...
            },
            {
                ...
                "candidate_review_frequency": "monthly",
                "candidate_review_config": {
                    "source_mode": "point_in_time_constituents",
                    "required_evidence": ["台灣50/0050成分股有效日期來源"],
                },
                "candidate_update_policy": "月頻檢查台灣50/0050成分股來源；若官方或自管有效日期表有異動才更新，不用現代成分股硬回推歷史。",
            ...
            },
            {
                ...
                "vote_group": "three_perspective_v1",
                "role_name": "風格補強專家",
                "role_description": "檢查 0050 成分股中，非 AI 主線但具中期上攻力的資金風格；每個風格只取一檔當期代表，避免金融或傳產因成員較多而取得不公平票數。",
                "candidate_review_frequency": "monthly",
                "candidate_review_config": {
                    "source_mode": "core_defensive_candidate_csv",
                    "path": "data/core_defensive_candidates.csv",
                    "required_evidence": [
                        "0050 / 台灣50 成分股或同等大型權值代表性",
                        "排除池1 AI主線個股後的風格補強定位",
                        "中期上攻力與相對0050優勢",
                        "回撤控制與機會成本合理",
                        "基本面品質未明顯惡化",
                ...
                "candidate_update_policy": "月頻檢查 0050 成分股中的非AI主線風格補強池；每個風格 bucket 只保留一檔當期代表，依產業代表性、中期上攻力、相對0050強度、機會成本、基本面品質與月頻審核分數更新，不追逐每日短線漲跌。",
                "description": "核心風格補強池：從 0050 / 台灣50 大型權值股中，排除池1 AI主線個股後，挑選金融、電信、消費、傳產與景氣循環等非AI主線風格代表；每個風格先選一檔代表，再與其他風格代表競爭。",
