...
- execution_blocked_rows：15
- bounded official raw execution gap unique keys：3
...
目前不可交 Experiments；只可依 bounded gap ledger 補 official close/OHLC execution legs。
